...
namespace BackOffice
{
    public class MaterialSkinManager
    {
        ...
        {
            ROBOTO_MEDIUM_12 = new Font(LoadFont(Resource2.Roboto_Medium), 12f);
            ROBOTO_MEDIUM_10 = new Font(LoadFont(Resource2.Roboto_Medium), 10f);
            ROBOTO_REGULAR_11 = new Font(LoadFont(Resource3.Roboto_Regular), 11f);
            ROBOTO_MEDIUM_11 = new Font(LoadFont(Resource2.Roboto_Medium), 11f);
            Theme = Themes.LIGHT;
